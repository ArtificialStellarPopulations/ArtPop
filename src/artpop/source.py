...
class SersicSSP(Source):
    ...
    def __init__(self, log_age, feh, phot_system, r_eff, n, theta, ellip,
                 ...
                 mass_tolerance=0.01, random_state=None):
        ...
        _distance = check_units(distance, 'Mpc').to('Mpc').value
        ...
        super(SersicSSP, self).__init__(
            _xy, self.ssp.mag_table, xy_dim, pixel_scale)

    def mag_to_image_amplitude(self, mtot, zpt):
        ...
        mu_e = mtot + 2.5 * np.log10(2 * area) + 2.5 * np.log10(f_n)
...
class PlummerSSP(Source):
    ...
    def __init__(self, log_age, feh, phot_system, scale_radius, distance,
        ...
        super(PlummerSSP, self).__init__(
            _xy, self.ssp.mag_table, xy_dim, pixel_scale)
